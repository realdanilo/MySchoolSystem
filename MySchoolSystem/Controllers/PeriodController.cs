...
namespace MySchoolSystem.Controllers
{
    public class PeriodController : Controller
    {
        ...
        public PeriodController(MyAppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SeasonName,Starts,Ends")] Period period)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SeasonName,Starts,Ends")] Period period)
        {
            if (id != period.Id)
            {
                return NotFound();
